...
parser.add_argument('--dataset', type=str, default='drug_mutation',
                    help='choose dataset')
parser.add_argument('--seed', type=int, default=2023,
                    help='Random seed.')
parser.add_argument('--mask_ratio', type=float, default=0.1,
                    help='random mask ratio')  ### 0.1
...
parser.add_argument('--beta', type=float, default=1e-1,
                    help='control contribution of loss contrastive')  ##5e-4 1e-1
parser.add_argument('--alpha', type=float, default=0.8,  ##0.8
                    help='control the contribution of inter and intra loss')
parser.add_argument('--augment', type=str, default='delete',
                    help='augment method')   #flip   delete add
...
for epoch in range(args.epochs):
    ...
    #y_score_test.to_csv('F:/2023年/新课题突变药物/Case study/drug_mutation_train.csv',index=False)
    ##case study
    numpy_array = y_score_test.detach().numpy()
    np.savetxt('F:/2023年/新课题突变药物/Case study/your_file.csv', numpy_array, delimiter=',')   ###save file
...
#print_list = ['test_auc', 'test_aupr','test_f1', 'test_macro_f1', 'test_micro_f1']
print_list = ['test_auc', 'test_aupr','test_f1', 'test_accuracy', 'test_recall','test_precision']
for i in print_list:
